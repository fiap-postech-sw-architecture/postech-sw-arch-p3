...
| [scan-fase-3.md](scan-fase-3.md) | Scans de fechamento da fase 3 (2026-07-11, evidência local) — bandit (app + lambda), pip-audit, ZAP, CodeQL, SonarQube e SBOM; trivy/gitleaks pendentes de cota do Actions |
